...
export default function Home({ feedbacks }: { feedbacks: DatabaseFeedback[] }) {
  ...
  return (
    <>
      <Head>
        <title>Learn thai language</title>
        ...
        <meta name="keywords" content="Learn Thai, Thai language courses, Thai lessons, language learning, ThinkThaiThai" />
          ...
          <section className={styles.courses}>
            <div className={styles.course}>
              <div className={styles.imageContainer}>
                <Image src="/conversationColor.png"
                  width={320}
                  height={320}
            ...
            <div className={styles.course}>
              <div className={styles.imageContainer}>
                <Image className={styles.beach} src="/videocallColor.png"
                  width={320}
                  height={320}
                  alt="A tourist asking for directions"
                />
